          ...
          {books.length > 0 ? (
            books.map((b, i) => (
              <motion.div
                ...
                className="h-full"
              >
                <Link href={`/catalog/${b.id}`} className="card h-full flex flex-col overflow-hidden hover:shadow-lg transition-all group bg-white rounded-2xl border border-beige/50">
                  ...
                  <div className="p-4 flex-1 flex flex-col w-full">
                    <div className="font-semibold line-clamp-1 mb-1 break-words" title={b.title}>{b.title}</div>
                    ...
                    <div className="mt-auto flex flex-wrap gap-2 items-center justify-between">
                      ...
                      <div className="text-[10px] uppercase tracking-wider px-2 py-1 bg-offwhite rounded-md border border-beige/50 truncate max-w-[120px]" title={b.category}>{b.category}</div>
                    </div>
                  </div>
                </Link>
              </motion.div>
